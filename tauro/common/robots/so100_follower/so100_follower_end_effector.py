...
from tauro.common.errors import DeviceNotConnectedError
from tauro.common.model.kinematics import RobotKinematics
from tauro.common.motors import Motor, MotorNormMode
from tauro.common.motors.feetech import FeetechMotorsBus
    ...
    def send_action(self, action: dict[str, Any]) -> dict[str, Any]:
        ...
        if self.current_ee_pos is None:
            self.current_ee_pos = self.kinematics.forward_kinematics(
                self.current_joint_pos, frame=EE_FRAME
            )
        ...
        target_joint_values_in_degrees = np.clip(
            target_joint_values_in_degrees, -180.0, 180.0
        )
