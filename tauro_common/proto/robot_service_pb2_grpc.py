...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in tauro_common/proto/robot_service_pb2_grpc.py depends on'
...
def add_RobotControlServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('tauro.common.proto.RobotControlService', rpc_method_handlers)
