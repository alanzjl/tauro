...
class CyberGearMotor(EventEmitter):
    ...
    def enable(self):
        """
        Enable the motor for commands.
        This needs to be called before any other commands.
        """
    ...
    def control(self, position: float, velocity: float, torque: float, kp: float, kd: float):
        """
    ...
    def set_parameter(self, param_name: ParameterName, value: int):
        ...
        cmd = Command.WRITE_PARAM_UPPER if addr >= PARAM_UPPER_ADDR else Command.WRITE_PARAM_LOWER
    ...
    def request_parameter(self, param_name: ParameterName):
        ...
        # Send
        cmd = Command.READ_PARAM_UPPER if addr >= PARAM_UPPER_ADDR else Command.READ_PARAM_LOWER
