...
# TODO: Implement cameras support
# from tauro_common.cameras.utils import make_cameras_from_configs
...
class SO101Follower(Robot):
    ...
    def observation_space(self) -> dict[str, dict]:
        ...
        for motor in motor_names:
            space[f"{motor}.pos"] = {"shape": (), "dtype": np.dtype(np.float32), "names": None}
        # Add camera observations if any
